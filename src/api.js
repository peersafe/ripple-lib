...
var getOfferTransactions = require('./ledger/Offertransactions');
...
var preparetransferPayment = require('./transaction/payment-transfer');
...
_.assign(RippleAPI.prototype, {
  ...
  getOfferTransactions:getOfferTransactions,
  ...
  preparetransferPayment:preparetransferPayment,
